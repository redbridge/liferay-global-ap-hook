...
<aui:form action="<%= configurationActionURL %>" method="post" name="fm" onSubmit="event.preventDefault();">
	...
	<liferay-util:buffer var="selectScope">
		...
		// START: Diff from original Liferay 6.2.1
		List<Group> userGroups = GroupLocalServiceUtil.getCompanyGroups(company.getCompanyId(), 0, Integer.MAX_VALUE);
        availableGroups.addAll(userGroups);
		// END: Diff from Original Liferay 6.2.1
